...
type Service interface {
	CreateAccount(ctx context.Context, name string, balance float64) (*core.Account, error)
	...
	Payment(ctx context.Context, accountID int, amount float64, pType storage.PaymentType, reference string) (*core.Account, error)
...
func (s *service) CreateAccount(ctx context.Context, name string, balance float64) (*core.Account, error) {
...
func (s *service) Transfer(ctx context.Context, fromID, toID int, amount float64, reference string) (*core.Account, *core.Account, error) {
	return s.store.Transfer(ctx, fromID, toID, amount, reference)
}

func (s *service) Payment(ctx context.Context, accountID int, amount float64, pType storage.PaymentType, reference string) (*core.Account, error) {
